...
.then(function (response)
 {
    ...
    fs.writeFileSync("cat300.jpg", response.data)
...
.then(function (response)
 {
    ...
    fs.writeFileSync("cat304.jpg", response.data)
console.log(response);
})
...
axios.get('https://http.cat/306', {responseType: 'arraybuffer'})
.then(function (response)
 {

    fs.writeFileSync("cat306to.jpg", response.data)
console.log(response);
})
